...
echo "nothing. (tests/Unit/Demo/FileEventStoreTest.php pins that refusal;"
echo "DemoCliShiftOpenRaceTest covers the different case of two shifts"
echo "racing for one terminal, which the slot reservation settles.)"
echo ""
