...
| [4002](4000-possession/4002-session-missing-operator-identity.md) | PosSession | PosSession carries no operator identity (asymmetric with Shift) | Missing Feature | High | Open | 2026-05-30 |
...
**Last Updated:** 2026-05-31 (filed 4002 — PosSession operator identity; 4002 + 9001 open)
