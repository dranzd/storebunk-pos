...
| [8003](8000-concurrency/8003-shift-enforcement-not-atomic.md) | Concurrency | Shift enforcement is check-then-store, not atomic under concurrency | Architecture | High | Open | 2026-08-17 |
